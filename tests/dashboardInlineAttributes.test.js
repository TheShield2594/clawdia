...
const BASELINE = {
    ...
    'partials/panels/commandpolicies.ejs': 19,
    'partials/panels/economy.ejs': 39,
    'partials/panels/eventlog.ejs': 6,
    'partials/panels/exploration.ejs': 4,
    'partials/panels/leveling.ejs': 28,
    'partials/panels/moderation.ejs': 25,
    'partials/panels/newspaper.ejs': 3,
    'partials/panels/overview.ejs': 8,
    'partials/panels/progressiontracks.ejs': 2,
    'partials/panels/quests.ejs': 3,
    'partials/panels/reactionroles.ejs': 5,
    'partials/panels/rss.ejs': 5,
    'partials/panels/social.ejs': 3,
    'partials/panels/season.ejs': 7,
    'partials/panels/suggestions.ejs': 4,
    'partials/panels/tempvoice.ejs': 1,
