...
_Generated by `npm run docs:commands` from the loaded command set — 89 entries. Edit the commands, not this list._
...
- `/shop` — Browse and buy across the server, hunt, fish and mine shops from one storefront
