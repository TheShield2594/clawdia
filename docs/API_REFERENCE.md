...
| `GET` | `/api/v1/guild/:guildId/members/:userId/ledger` | session, guild admin | One page of a member's transaction ledger, newest first, plus every owed payout still outstanding for them |
