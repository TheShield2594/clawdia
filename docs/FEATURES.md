...
_Generated by `npm run docs:panels` from the dashboard sidebar and `src/dashboard/views/partials/panels/` — 26 sections, in the order the sidebar shows them. Edit the panels, not this table._
