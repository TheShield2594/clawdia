...
Nothing in the bot's behaviour changes with this release. It exists to give the
migration series above a deployable version to map to, and to give
`portainer-stack.yml` a tag it can pin instead of `:latest`.
