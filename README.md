...
`/fish` alone is 3,691 lines — more than the Fun, AI, Leveling and Admin command sets put together (2,767).
...
- **Social Notifications**: Post to a channel when a creator uploads or an account posts — YouTube and Reddit out of the box; X, Instagram, and TikTok via an optional RSSHub bridge
