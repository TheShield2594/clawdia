...
`/fish` alone is 4,271 lines — more than the Community, Fun, AI, Leveling and Admin command sets put together (3,941).
...
- **Social Notifications**: Post to a channel when a creator uploads or an account posts — YouTube, Reddit, and X out of the box (X through the free FxTwitter API, with full text, photo galleries, video, quotes, and link cards); Instagram and TikTok via an optional RSSHub bridge
