...
// The /explore go result card's record marker (utils/grindRecord). The mine's
// record reads data.bestPayout, which the index above already serves.
grindProfileSchema.index({ guildId: 1, system: 1, 'data.bestHaul': -1 });
