...
const CATEGORIES = [
    {
        ...
        commands: [
            ...
            { name: 'hunt',           description: 'Hunt animals in your zone (45s cooldown)' },
            ...
            { name: 'huntshop',       description: 'Buy weapons, ammo, consumables, and unlock zones — all in one place' },
            { name: 'huntzone',       description: 'View and switch your active hunting zone' },
            ...
            { name: 'fish',           description: 'Cast your line and catch fish (45s cooldown)' },
            ...
            { name: 'fishshop',       description: 'Buy rods, bait, consumables, and unlock locations — all in one place' },
            { name: 'fishlocation',   description: 'View and switch your active fishing location' },
