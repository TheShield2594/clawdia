...
// `/rob status <user>` — scout a target's rob protections before committing to a
// heist (#1022). This was `/robstatus` before the fold; its 2-minute per-user
// cooldown is its own in-memory map, kept here so it stays a property of the
// scout and not of the shared `/rob` slot.
