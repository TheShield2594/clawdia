...
// `/rob attempt` — try to rob another member's wallet (#1022).
//
// This was the whole of `/rob` before #1022 folded the scouting (`/robstatus`)
// and the tripwire (`/trap`) in beside it as `/rob status` and `/rob trap`. The
// attempt logic is unchanged; it moved here so the three live under one command
// without one 700-line file.
