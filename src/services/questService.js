...
const DAILY_QUEST_POOL = [
    ...
    { questId: 'daily_pet_care_3',      name: 'Good Owner',         description: 'Feed, play with, train or battle your pets 3 times',
...
/** Any pet interaction: feeding, playing, training or battling. */
