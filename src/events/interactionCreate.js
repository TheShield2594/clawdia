...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        const cooldownRefusal = await claimCommandCooldown(client, command, interaction, guildSettings);
        if (cooldownRefusal) {
            return sendEphemeralResponse(interaction, { content: cooldownRefusal });
        }
