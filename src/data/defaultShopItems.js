...
const DEFAULT_SHOP_ITEMS = [
    ...
    { name: 'Lifesaver',          itemId: 'lifesaver',         rarity: 'Rare',     price: 4000,  description: '🛟 Absorbs the next /rob fine or /crime loss — one-time use.',     lore: "Inexplicably shows up right when you need it most. Nobody knows where it comes from." },
    { name: 'Lucky Charm',        itemId: 'lucky_charm',       rarity: 'Common',   price: 2000,  description: '🍀 2-hour luck boost across games and /crime.',                    lore: "Found at the bottom of a leprechaun's pocket. Still faintly smells of gold." },
