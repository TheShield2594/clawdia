...
const DEFAULT_SHOP_ITEMS = [
    ...
    { name: 'Revive Scroll',      itemId: 'revive_scroll',     rarity: 'Rare',     price: 15000, description: '📜 Calls home the pet that most recently ran away hungry, with its level and battle record intact (use with /use).', lore: "The ink is still wet. Somewhere, a very hungry animal decides it isn't finished with you yet." },
    ...
    { name: 'Permanent Stamina +1',   itemId: 'permanent_stamina',       rarity: 'Mythic', price: 100000, category: 'prestige', description: '⚡ Permanently increases your max hunt/fish/mine stamina by 1 (stackable ×3, use with /use).', lore: "The grind never ends. At least now you last a little longer." },
