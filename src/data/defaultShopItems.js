...
const DEFAULT_SHOP_ITEMS = [
    ...
    { name: 'Knife',              price: 3000, description: '🔪 +15% success chance on your next /rob attempts.' },
    { name: 'Robbery Bag',        price: 3500, description: '💼 +10% coins stolen on successful /rob attempts.' },
    ...
    { name: "Finder's Fee",       price: 1500, description: '💸 Bonus coins on lucky finds — passive until consumed.' },
